...
func getEmptyList() SinglyLinkedList {
...
func getOneNodeLongList() SinglyLinkedList {
	node := &node{
		element: uint16(0),
		next:    nil,
	}
...
func getOddNumberLongList() SinglyLinkedList {
...
func getEvenNumberLongList() SinglyLinkedList {
	list := getOneNodeLongList()
	var nod *node
...
func TestSinglyLinkedList_AddAtHead(t *testing.T) {
...
func TestSinglyLinkedList_RemoveAtEndAtEnd(t *testing.T) {
...
func TestSinglyLinkedList_RemoveAtEndAtHead(t *testing.T) {
	dataTable := []struct {
		name string
		data SinglyLinkedList
		want interface{}
...
func TestSinglyLinkedList_GetFirstElement(t *testing.T) {
	dataTable := []struct {
		name string
		data SinglyLinkedList
		want interface{}
...
func TestSinglyLinkedList_GetLastElement(t *testing.T) {
	dataTable := []struct {
		name string
		data SinglyLinkedList
		want interface{}
